    ...
    <section className="py-16">
      <div className="flex flex-col space-y-12">
        <div className="flex items-center justify-between">
          ...
          <Link href="#" className="text-sm font-headline uppercase tracking-widest text-primary flex items-center gap-2 hover:opacity-70 transition-opacity">
        ...
        <div className="grid grid-cols-1 gap-12">
          {articles.map((article) => (
            <article key={article.title} className="group cursor-pointer">
              <Link href="#" className="flex flex-col md:flex-row gap-4 md:gap-12 md:items-start">
