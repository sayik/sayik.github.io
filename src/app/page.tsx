          ...
          <div className="lg:col-span-8 space-y-16">
            ...
            <section id="open-source">
              <div className="flex items-center justify-between mb-12 border-b-2 border-foreground pb-4">
                <h2 className="text-xs font-headline uppercase tracking-[0.4em] font-black text-foreground">Open Source Contributions</h2>
                <Link 
                  href="https://github.com/sayik" 
                  target="_blank" 
                  className="flex items-center gap-2 text-[10px] font-headline uppercase tracking-widest hover:text-primary transition-all font-black text-foreground"
                >
